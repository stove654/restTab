...
var databaseUrl = "./db/tables.db";
var db = {
  tables: new nedb({ filename: databaseUrl, autoload: true })
};

exports.index = function(req, res) {
  db.tables.find({}, function(err, result) {
    res.json(200, result);
  });
};
...
exports.create = function(req, res) {
  /*db.tables.insert(req.body, function (err, user) {
