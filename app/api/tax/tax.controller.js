...
var databaseUrl = "./db/taxes.db";
var db = {
  taxes: new nedb({ filename: databaseUrl, autoload: true })
};

exports.index = function(req, res) {
  db.taxes.find({}, function(err, result) {
    res.json(200, result);
  });
};
...
exports.create = function(req, res) {
  db.taxes.insert(req.body, function (err, user) {
