...
var databaseUrl = "./db/discounts.db";
var db = {
  discounts: new nedb({ filename: databaseUrl, autoload: true })
};

exports.index = function(req, res) {
  db.discounts.find({}, function(err, result) {
    res.json(200, result);
  });
};
...
exports.create = function(req, res) {
  db.discounts.insert(req.body, function (err, user) {
