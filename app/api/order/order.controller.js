...
var databaseUrl = "./db/order.db";
var db = {
  order: new nedb({ filename: databaseUrl, autoload: true })
};

exports.index = function(req, res) {
  db.order.find({}, function(err, result) {
    res.json(200, result);
  });
};
...
exports.create = function(req, res) {
  db.order.insert(req.body, function (err, user) {
